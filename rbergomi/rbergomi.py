...
if __name__ == "__main__":
    ...
    model = rBergomi(n=100, N=3, T=1.0, a=-0.4)
    dW1 = model.dW1()
    Y = model.Y(dW1)
    dW2 = model.dW2()
    ...
    plt.plot(model.t[0], S[0], label='rBergomi Path')
    plt.plot(model.t[0], S[1], label='rBergomi Path 2')
    plt.plot(model.t[0], S[2], label='rBergomi Path 3')
    plt.show()
